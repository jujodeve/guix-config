;; jotix emacs configuration for emacs in guix

(setq jtx-emacs-config-file "~/guix-config/home-config/dotfiles/.emacs.d/init.el")
...
;; setting font and themes for emacs clients
(if (daemonp)
